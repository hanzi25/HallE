...
output_path=/raid_sdd/zzy/experiments/halle/train/exp11_llava_verifier_logits_original_vision_scalar_frozen_1.0_joint_6+3+1k_1ep_16bz_3e5/eval/pope_evaluation
...
do
    ...
    CUDA_VISIBLE_DEVICES=2 python eval.py \
        --model-path /raid_sdd/zzy/experiments/halle/train/exp11_llava_verifier_logits_original_vision_scalar_frozen_1.0_joint_6+3+1k_1ep_16bz_3e5 \
