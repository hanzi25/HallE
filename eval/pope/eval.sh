annotation_dir="/raid_sdd/whz/data/pope"
...
output_path=/raid_sdd/whz/experiments/halle/train/exp7_llava_verifier_scalar_init_0.1_sharegpt_9k_1ep_16bz_3e5/eval/pope_evaluation
...
do
    ...
    CUDA_VISIBLE_DEVICES=0 python eval.py \
        --model-path /raid_sdd/zzy/experiments/halle/train/exp7_llava_verifier_scalar_init_0.1_sharegpt_9k_1ep_16bz_3e5 \
