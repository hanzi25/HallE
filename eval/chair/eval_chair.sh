python chair.py \
    ...
    --save_path /raid_sdd/zzy/experiments/halle/train/exp12_llava_verifier_logits_scalar_frozen_1.0_joint_5+3+1+detailed+qa1k_1ep_16bz_3e5/eval/eval_CHAIR.json