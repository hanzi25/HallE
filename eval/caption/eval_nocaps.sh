...
CUDA_DEVICE_ORDER=PCI_BUS_ID CUDA_VISIBLE_DEVICES=0 python eval_nocaps.py \
	...
	--output_folder /raid_sdd/zzy/experiments/halle/train/exp12_llava_verifier_logits_scalar_frozen_1.0_joint_8+0.5+0.5_1ep_16bz_3e5/eval/nocaps/short 
...
# 	--gt_file_path /raid_sdd/zzy/data/halle/NoCaps/nocaps_val.json \
# 	--image_path /raid_sdd/zzy/data/halle/NoCaps \
# 	--output_folder /raid_sdd/zzy/HallE/tmp/llava_eval/nocaps/short 