...
class TrainingArguments(transformers.TrainingArguments):
    ...
    vision_layer: int = field(default=32)
...
def train():
    ...
    if model_args.vision_tower is not None: # mllm
        if 'mpt' in model_args.model_name_or_path:
            ...
            config.vision_layer = training_args.vision_layer
