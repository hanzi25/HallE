...
if __name__ == '__main__':
    ...
    # Get word list from the caption
    words, node_words, idxs, double_words = chair.caption_to_words(example_caption)

    # Print extracted information
    print("Words:", words)
    print("Node Words (MSCOCO Objects):", node_words)
    print("Indexes:", idxs)
    print("Double Words:", double_words)
