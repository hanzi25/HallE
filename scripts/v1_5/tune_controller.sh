deepspeed --include localhost:3 --master_port 25001 llava/train/train_switch.py \
    ...
    --bf16 True \
    --output_dir /work/zangzeyuan/exp16_llava_7b_controller_joint_6+3+1_1ep_16bz_3e5 \
    --num_train_epochs 1 \
