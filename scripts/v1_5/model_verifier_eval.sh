CUDA_DEVICE_ORDER=PCI_BUS_ID CUDA_VISIBLE_DEVICES=3 python3 eval/model_controller.py \
            --model-path /raid_sdd/zzy/experiments/halle/train/exp13_llava_verifier_logits_scalar_frozen_1.0_joint_6+3+1_layer32_1ep_16bz_3e5 \
            ...
            --output_folder /raid_sdd/zzy/experiments/halle/train/exp13_llava_verifier_logits_scalar_frozen_1.0_joint_6+3+1_layer32_1ep_16bz_3e5/eval/1.0/
