CUDA_DEVICE_ORDER=PCI_BUS_ID CUDA_VISIBLE_DEVICES=0 python3 eval/model_controller.py \
            --model-path /raid_sdd/zzy/experiments/halle/train/exp7_llava_verifier_scalar_frozen_0.1_sharegpt_9k_1ep_16bz_3e5  \
            ...
            --output_folder /raid_sdd/zzy/experiments/halle/train/exp7_llava_verifier_scalar_frozen_0.1_sharegpt_9k_1ep_16bz_3e5/eval/