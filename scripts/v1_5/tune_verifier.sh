deepspeed --include localhost:0,1,2,3 --master_port 25431 llava/train/train_verifier.py \
    ...
    --bf16 True \
    --output_dir /raid_sdd/zzy/experiments/halle/train/exp5_llava_verifier_scalar_minus1_9k_1ep_8bz_3e5 \
    --num_train_epochs 1 \
