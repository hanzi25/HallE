deepspeed --include localhost:0 --master_port 25436 llava/train/train_verifier.py \
    ...
    --bf16 True \
    --output_dir /raid_sdd/zzy/experiments/halle/train/exp7_llava_verifier_scalar_init_0.1_sharegpt_50k_1ep_8bz_3e5 \
    --num_train_epochs 1 \
