deepspeed --include localhost:0 --master_port 25437 llava/train/train_verifier.py \
    ...
    --model_name_or_path /raid_sdd/zzy/model/InternVL-Chat-ViT-6B-Vicuna-7B \
    --version v1 \
    ...
    --bf16 True \
    --output_dir /raid_sdd/zzy/experiments/halle/train/exp15_internvl_chat_vit_6b_vicuna_7b_verifier_logits_scalar_frozen_1.0_joint_6+3+1_1ep_16bz_3e5 \
    --num_train_epochs 1 \
